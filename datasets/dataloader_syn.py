    ...
    def get_train_batch(self, idx):
        try:
            ...
            for i, num in enumerate(self.num_samples):
                ...
                # subsample_indices =np.random.choice(len(boundary_samples),num,replace=False)
                # subsample_indices =torch.from_numpy(subsample_indices).reshape(num,-1)
            ...
            input_dict['sem_interp_idx'] = np.array([])
